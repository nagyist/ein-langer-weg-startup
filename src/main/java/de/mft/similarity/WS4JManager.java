...
public class WS4JManager {
    ...
    {
		String query = "Band";
		WS4JManager ws4 = new WS4JManager();
		System.out.println(ws4.calculateSimilarityToAllClasses(query));
		System.out.println(ws4.autoQueryClassification(query));
    }
